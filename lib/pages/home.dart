  ...
  Widget build(BuildContext context) {
    ...
    if(settingsData.isEmpty){
      settingsData = {
        'lon' : 2.3281126,
        'lat' : 48.8909971,
        'schedules': [{'type': 'metros', 'code': '13', 'stationCode': 'Guy+Moquet', 'station': 'Guy Moquet', 'way': 'A'}],
      };
    }

    final Schedule newSchedule = Schedule(lineDetails: settingsData['schedules']);
    final FutureWeather newWeather = FutureWeather(lat: settingsData['lat'], lon: settingsData['lon'], gmt: 1);
